...

{
   ...
   if($transactiondetails['debit']=='' && $transactiondetails['credit'] !='')
	...
	$accountdetails = $accountdetails.',{"class":"row'.$account.'" , "type" : "div",
	"child":[{"type":"checkbox","value":"'.$amount.'" ,"name":"checked","class":"ckbox'.$amount.'","readonly":"", "style":""},
	{ "type":"text","value":"Change" ,"name":"","class":"chng'.$amount.'","readonly":"readonly", "style":""},
	{ "type":"text","value":"Confirm" ,"name":"","class":"confirm'.$amount.'","readonly":"readonly", "style":"display-none"},
	...
	$accountdetails = $accountdetails.',{"parent":[{"class":"row'.$account.'" , "type" : "div",
	"child":[{"type":"checkbox","value":"'.$amount.'" ,"name":"checked","class":"ckbox'.$amount.'","readonly":"", "style":""},
	{ "type":"text","value":"Change" ,"name":"","class":"chng'.$amount.'","readonly":"readonly", "style":""},
	{ "type":"text","value":"Confirm" ,"name":"","class":"confirm'.$amount.'","readonly":"readonly", "style":"display-none"},
	{ "type":"text","value":"'.$date.'" ,"name":"","class":"fieldsbackreconDate","readonly":"readonly", "style":""},
