...
<input type='text' class ='fieldsbankreconadd' readonly='readonly' value='Date' /> 
<input type='text' class ='fieldsbankreconadd' readonly='readonly' value='Description'/> 
<input type='text' class ='fieldsbankreconadd' readonly='readonly' value='ReqCode'/> 
<input type='text' class ='fieldsbankreconadd' readonly='readonly' value='Debit' /> 


<input type='text' class ='fieldsbankreconadd' readonly='readonly' value='Credit' /> 
<input type='text' class ='fieldsbankreconadd' readonly='readonly' value='Balance'/> </div>

<div id='<?php echo 'adddivrow'.$accountnumber;?>' class='pickrow' >
<div class='<?php echo 'addrow'.$accountnumber;?>'> 
